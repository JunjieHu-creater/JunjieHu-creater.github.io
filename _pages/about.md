...
- **J. Hu**, J. Bai, J. Yang, & J. Lee, Crash Risk Prediction Using Sparse Collision Data: Causal Inference and Graph Convolutional Networks Approaches, *Expert Systems with Applications*, 125315. https://doi.org/10.1016/j.eswa.2024.125315,2024.
...
- **J. Hu**, Zhang, J. Bai, & J. Lee, Unraveling the Dynamic Rules of Urban Traffic Crashes: Tucker-Net Based SIRS Model, Available at SSRN: [https://ssrn.com/abstract=4697054](https://ssrn.com/abstract=4697054) or [http://dx.doi.org/10.2139/ssrn.4697054](http://dx.doi.org/10.2139/ssrn.4697054).
...
- **J. Hu**,  J. Lee, Car following dynamics in mixed traffic flow of autonomous and human-driven vehicles: complex networks approach,Physica A: Statistical Mechanics and its Applications,Volume 665,2025,130519,ISSN 0378-4371,https://doi.org/10.1016/j.physa.2025.130519.
...
- **J. Hu**,  J. Bai, & J. Lee, Simplified and Efficient KNN-Based Method for High-Resolution Traffic Time Space Diagram Imputation， Under review.
...
- **J. Hu**,  D. Gao, C. Hu, H. zhou & J. Lee, Rethinking driving style recognition: A prediction error-based driving behavior modeling, Under review.
<br>**In this work**<em>, I have revisited an end-to-end approach to driving style recognition by exploring the heterogeneity of driver behaviors through the errors in trajectory prediction models. In this paper, I have utilized spatial attention and convolutional social pooling to learn the interdependencies within vehicle motion and introduced a multi-modal distribution for future trajectories based on driving style. </em>

- **J. Hu**,  D. Gao, J. Lee  & L.Wang, Vehicle dynamics analytics based on complex network techniques: a trajectory-based visibility graph approach, Under review.
<br>**In this work**<em>, I have introduced an adaptive trajectory-based visibility graph (TVG) framework, a novel approach for dissecting vehicle dynamics by transforming planar trajectory data into complex networks. Central to this framework is a tunable visibility tolerance coefficient, dynamically scaled by lateral displacement, which uniquely allows the TVG to capture geometric occlusions and maneuver-specific spatial scales. </em>
...
- L. Wang, **J. Hu**, Y. Yang & J. Lee , Analysis of injury severity of single-vehicle and two-vehicle crashes with lightweight vehicles (kei cars) in Japan: A random parameters approach with heterogeneity in means, Under review.
<br>**In this work**<em>, I have assisted in the investigation of the crash injury severity of K-cars using a random parameters probit model with heterogeneity in means, and designed the out-of-sample prediction approach to clarify the heterogeneity among various crash severity mechanisms. </em>
